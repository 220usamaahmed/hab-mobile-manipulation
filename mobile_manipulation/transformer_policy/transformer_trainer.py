...
from mobile_manipulation.transformer_policy.dataset import RollingDataset
...
class TransformerTrainer(BaseRLTrainer):
    ...
    def save_checkpoint(
        ...
        print("saved check point == " , file_name)
    ...
    def _run_epoch(self, split: str, epoch_num: int = 0):
        ...
        for it, (x, y, r, t) in pbar:
            ...
            print("obs joints == " ,x['joint'].shape) 
            print("obs skills == " , x['skill'].shape)
            print("obs robot_head_depth == " , x['robot_head_depth'].shape)
            print("y == ", y[0])
            print("r == " , r[0])
            print("t == " , t[0])
            print("itr == ", it) 
            ...
            with torch.set_grad_enabled(True):
                loss, loss_dict = self.transformer_policy(x, prev_actions, y, r, t)
                loss = (
                    loss.mean()
    ...
    def _eval_checkpoint(
       ...
       # input()
        ...
        test_recurrent_hidden_states = torch.zeros(
            ...
            self.actor_critic.num_recurrent_layers,  ## context length
    ...
    def get_oracle_skill(self, observations):
        mask_hold = observations['all_predicates'][:,10].bool()  ### this should be modified
