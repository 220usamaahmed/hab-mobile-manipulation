     ...
     #   print(self.actor_critic.net.visual_encoder)
      ...
      #  input()
        ...
        if Diffusion_policy:
            ...
            diffusion_policy.load_state_dict(torch.load("/home/shokry/hab-mobile-manipulation/collected_data_diffusion/tidy_house/more_data/processed_data/marvin_weights/model_all_tasks_eval_dataset_5_prev_obs_20_act_4400.pt",
                                                    map_location=device))
             ...
             #   input()
                ...
                if episode_success==1:
                    ...
                    if num_suc_episodes%50 == 49 and Save_data:
                        ...
                        with open('/home/shokry/hab-mobile-manipulation/collected_data_diffusion/tidy_house/more_data/place_only_eval_dataset_ep_0_part_{}.pkl'.format(saves), 'wb') as f:
