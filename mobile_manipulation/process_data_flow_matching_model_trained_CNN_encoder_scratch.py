...
directory = '/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/collected_dataset'

flow_matching_model_directory='/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/weights_flow_matching_CNN_encoder_scratch_head_and_arm_depth_without_action_extension'
checkpoint= torch.load( os.path.join(flow_matching_model_directory, 'flow_matching_Cnn_encoder_scratch_without_act_ext_enhanced_sampling_2800.pt'),map_location=device )
...
def process_data(upload_directory,save_directory,num_prev_obs=5, num_predicted_actions=20):
    ...
    skill_files=[]
    if required_skill!='nav_to_drawer_pos' and required_skill!='nav_to_place_pos'and required_skill!='open_drawer' and required_skill!='pick_from_drawer' and required_skill!='place_task':
    ...
    for file_name in skill_files:
       ...
       # print("Completed processing file: ", file_name )
        ...
        if number_of_processed_files % 25 ==0 or number_of_processed_files==number_of_files:
...
save_directory=directory+'/processed_data_flow_matching_CNN_encoder_scratch_epoch_2800'
