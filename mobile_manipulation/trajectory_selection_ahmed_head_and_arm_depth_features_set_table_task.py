...
ROOT = "/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/collected_dataset/processed_data_flow_matching_CNN_encoder_scratch_epoch_2800"
Diffusion_model_path = "/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/weights_flow_matching_CNN_encoder_scratch_head_and_arm_depth_without_action_extension"
Critic_model_path = "/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/collected_dataset/processed_data_flow_matching_CNN_encoder_scratch_epoch_2800/critic_weights"
...
number_of_epochs_to_update_returns=50
       ...
       #     print("maximum returns in critic training epoch {} == {}".format(epoch, torch.max(returns)))
        ...
        if epoch != 0 and epoch % number_of_epochs_to_update_returns == 0:
            ...
            torch.save({
                ...
                'epoch': epoch,
            }, path.join(Critic_model_path, f'ckpt_with_normalization_without_uncertainty_head_arm_depth_no_input_dropout_set_table_ep_{epoch}.pt'))
