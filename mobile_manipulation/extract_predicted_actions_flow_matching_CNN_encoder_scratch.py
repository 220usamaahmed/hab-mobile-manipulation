...
if __name__ == "__main__":
    data_directory='/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/collected_dataset/processed_data_flow_matching_CNN_encoder_scratch_epoch_2800'
   # data_directory='/home/shokry/hab-mobile-manipulation/collected_data_diffusion/tidy_house/more_data/processed_data'
    diffusion_model_directory='/lustre/mlnvme/data/s47ashok_hpc-data/final_dataset_27_jan/set_table/seed_100/weights_flow_matching_CNN_encoder_scratch_head_and_arm_depth_without_action_extension/flow_matching_Cnn_encoder_scratch_without_act_ext_enhanced_sampling_2800.pt'
  ...
  #  required_skill='nav_to_drawer_pos'
   # if required_skill!='nav_to_drawer_pos' and required_skill!='nav_to_place_pos'and required_skill!='open_drawer' and required_skill!='pick_from_drawer' and required_skill!='place_task':
    #    print("please set a valid skill among nav, pick, place")
     #   input()
    for required_skill in ['nav_to_place_pos','place_task']:
